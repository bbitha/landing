...
<head>
  ...
  <meta name="description" content="Desarrollo de software personalizado, asistencia técnica y consultoría en tecnología para impulsar tu negocio">
...
<body>
    ...
    <div class="container">
      <div class="row align-items-center">
        <div class="col-lg-6">
          ...
          <p class="lead mb-4">Soluciones de software personalizadas diseñadas para optimizar tus operaciones y potenciar tu crecimiento.</p>
  ...
  <section class="py-5 bg-light">
    <div class="container">
      <div class="row align-items-center">
          ...
          <p>En CLARVID entendemos que cada minuto cuenta. Por eso hemos desarrollado un sistema de soporte multicanal que combina:</p>
      ...
      <div class="row justify-content-center">
        <div class="col-lg-8">
          <div class="contact-section">
            ...
            <p class="text-center mb-4">Completa el formulario y nos pondremos en contacto contigo en menos de 24 horas.</p>
            ...
            <form method="POST" action="{{ route('contact.send') }}">
              ...
              <div class="mb-3">
                ...
                <input type="text" class="form-control p-3" id="nombre" name="nombre" placeholder="Ingresa tu nombre" required>
              </div>
              
              <div class="mb-3">
                <label for="email" class="form-label">Correo electrónico</label>
                <input type="email" class="form-control p-3" id="email" name="email" placeholder="Ingresa tu email" required>
              </div>
              
              <div class="mb-4">
                <label for="mensaje" class="form-label">Mensaje</label>
                <textarea class="form-control p-3" id="mensaje" name="mensaje" rows="4" placeholder="Cuéntanos sobre tu proyecto" required></textarea>
              </div>
  ...
  <footer>
    <div class="container">
      <div class="row">
        <div class="col-md-6">
          <h4><i class="fas fa-laptop-code me-2"></i>Tecnología CLARVID</h4>
          <p>Soluciones digitales para empresas innovadoras.</p>
        </div>
        <div class="col-md-6 text-md-end">
          <p class="mb-0">© 2025 Tecnología CLARVID. Todos los derechos reservados.</p>
        </div>
      </div>
    </div>
  </footer>
